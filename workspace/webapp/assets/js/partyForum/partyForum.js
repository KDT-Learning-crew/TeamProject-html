...
function getPost(page) {
  ...
  postDisplay.forEach(post => {
    ...
    postItem.innerHTML = `
      <div class="partyForum-list-writer">${post.writer}</div>
      <div class="partyForum-list-userSkill">${post.userSkill}</div>
      <div class="partyForum-list-title">${post.title}</div>
      <div class="partyForum-list-write-time">${post.writeTime}</div>
    `;
...
writeBtn.addEventListener("click", function () {
  var link = '../../html/partyForum/partyForumWriting.html';
  location.href = link;
